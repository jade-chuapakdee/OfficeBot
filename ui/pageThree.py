...
class PageThree(tk.Frame):
    def __init__(self, master):
        ...
        label1 = tk.Label(self, text=label1_text, bg='#e6bb95', font=("Ubuntu", 16, "bold"))
        label1.place(x=300, y=150)
        label2_text = "Reason: " + master.shared_reason.get()
        label2 = tk.Label(self, text=label2_text, bg='#e6bb95', font=("Ubuntu", 16, "bold"))
        label2.place(x=300, y=200)

        return_button = tk.Button(self, text="OK", command=on_click_return, width=10, height=1,
                                  bg="#83c6d2", fg="black", font=("Ubuntu", 16, "bold"), borderwidth=1)
